                ...
                this.load(
                    ...
                    function(xhr) {
                        if (xhr.status !== 0) {
                            ...
                            var url = '{{ route("telescope-toolbar.show", ["token" => "xxxxxx"]) }}'.replace(/xxxxxx/, newToken);
                            sfwdt.innerHTML = '\
                                <div class="sf-toolbarreset">\
                                    ...
                                    An error occurred while loading the web debug toolbar. <a href="' + url + '>Open the web profiler.</a>\
                                </div>\
                            ';
